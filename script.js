...
(() => {
  ...
  const translations = {
    fr: {
      ...
      "faq.q1": "Quelle monnaie utiliser ?", "faq.a1": "À Prague, on paie en couronnes tchèques (CZK). Les euros sont rarement acceptés, et quand ils le sont, le taux est souvent mauvais. Une carte Visa ou Mastercard sans frais à l’étranger, plus un peu de cash pour les petits commerces, suffit largement.",
      "faq.q2": "Prague est-elle sûre ?", "faq.a2": "Oui, dans l’ensemble. C’est une ville où l’on peut se promener tranquillement, y compris le soir dans le centre. Comme partout en zone touristique, il faut simplement faire attention aux pickpockets et éviter les taxis non officiels.",
      "faq.q3": "Y a-t-il du racisme ou de la xénophobie à Prague ?", "faq.a3": "La réponse est nuancée. Prague est une ville touristique et, dans l’ensemble, les visiteurs peuvent y séjourner normalement, sans rencontrer de problème particulier lié à leur origine ou à leur couleur de peau.<br><br>Cependant, certaines personnes peuvent vivre des expériences différentes. Des voyageurs noirs, arabes ou asiatiques ont parfois rapporté des regards insistants, une certaine distance dans les échanges, un sentiment d’être davantage observés ou, dans certains cas, des difficultés à entrer dans certains établissements.<br><br>Ces situations ne concernent pas tous les voyageurs et ne permettent pas de dire que Prague est une ville raciste ou xénophobe. Elles font néanmoins partie des expériences que certains visiteurs peuvent rencontrer.<br><br>Il est aussi important de faire la différence entre une expérience personnelle et une réalité générale. Une personne peut se sentir mal accueillie dans un endroit précis alors qu’une autre, dans la même ville, vivra une expérience totalement différente.<br><br>L’expérience de Prague dépend donc aussi de la personne, du lieu, du contexte et de la situation rencontrée. Le plus juste est de reconnaître les témoignages qui existent sans généraliser à l’ensemble de la ville ou de ses habitants.",
      "faq.q4": "Quels bars éviter, et où aller plutôt ?", "faq.a4": "Autour de la Place de la Vieille Ville, beaucoup de bars sont très touristiques : bruyants, chers, et pas toujours agréables. Pour une bière dans un cadre plus local, les beer gardens de Letná ou de Riegrovy sady sont de bons choix. Les quartiers de Vinohrady et de Žižkov offrent aussi des lieux plus calmes et plus authentiques.",
      "faq.q5": "Quel aéroport, et comment rejoindre le centre ?", "faq.a5": "L’aéroport s’appelle Václav Havel (code PRG). Le plus simple est de prendre le bus 119 jusqu’à Nádraží Veleslavín, puis le métro. Comptez environ 40 à 60 minutes pour arriver en centre-ville. C’est fiable et bien moins cher qu’un taxi.",
      "faq.q6": "Quel budget prévoir ?", "faq.a6": "En moyenne, 60 à 100 € par jour suffisent pour un séjour confortable. Une bière locale coûte environ 1,50 à 3 €, un repas 8 à 15 €, et la plupart des attractions entre 10 et 20 €. On peut bien sûr dépenser moins ou davantage selon le style de voyage.",
      "faq.q7": "Comment fonctionne le métro et les transports ?", "faq.a7": "Le réseau métro, tram et bus est excellent et couvre presque toute la ville. Un simple ticket de 30 ou 90 minutes permet de combiner les trois, sans acheter un billet par trajet.<br><br>Ce qui m’a le plus marqué : l’absence de tourniquets. On entre librement, et pourtant personne ne semble tricher. Les stations sont souvent très profondes, avec des escalators interminables, et l’ensemble est propre et calme. L’eau du robinet est potable, le Wi-Fi est largement disponible ; les toilettes publiques sont souvent payantes.",
      "faq.q8": "Quelle est la meilleure période pour visiter ?", "faq.a8": "Avril–juin et septembre–octobre sont les plus agréables : douceur, moins de foule. L’hiver a le charme des marchés de Noël, mais il fait froid. Juillet–août, c’est la haute saison : plus de monde et des prix plus élevés.",
      "faq.q9": "Un week-end suffit-il pour Prague ?", "faq.a9": "Oui, pour découvrir le cœur de la ville. En deux jours, on peut voir la Vieille Ville, l’horloge astronomique, le Pont Charles, Malá Strana, le Château, le quartier juif et même un détour par le métro. Ce carnet en est l’exemple. En revanche, un week-end ne suffit pas si l’on veut aussi des excursions (Kutná Hora, Český Krumlov, etc.).",
      "faq.q10": "Faut-il se lever tôt pour le Pont Charles ?", "faq.a10": "Oui, si l’on veut le pont presque vide et une belle lumière. Au lever du soleil, l’ambiance est très différente de celle de la journée, quand la foule est dense. Le Château en fin de journée, au coucher du soleil, offre aussi une vue mémorable sur la ville.",
      ...
      "about.mexico": "Si Prague vous a plu, poursuivez le voyage : découvrez mon carnet photo au Mexique — pyramides, couleurs et une autre façon de ressentir une ville.",
    ...
    en: {
      ...
      "faq.q1": "What currency should I use?", "faq.a1": "In Prague you pay in Czech koruna (CZK). Euros are rarely accepted, and when they are, the rate is often poor. A fee-free Visa or Mastercard for abroad, plus a little cash for small shops, is usually enough.",
      "faq.q2": "Is Prague safe?", "faq.a2": "Yes, overall. You can walk around calmly, including in the centre in the evening. As in any tourist area, simply watch out for pickpockets and avoid unofficial taxis.",
      "faq.q3": "Is there racism or xenophobia in Prague?", "faq.a3": "The answer is nuanced. Prague is a tourist city and, overall, visitors can stay there normally without particular problems linked to their origin or skin colour.<br><br>However, some people may have different experiences. Black, Arab or Asian travellers have sometimes reported insistent stares, a certain distance in interactions, a feeling of being watched more closely or, in some cases, difficulty entering certain venues.<br><br>These situations do not affect every traveller and do not mean Prague is a racist or xenophobic city. They are nonetheless part of what some visitors may encounter.<br><br>It is also important to distinguish a personal experience from a general reality. One person may feel unwelcome in a specific place while another, in the same city, has a completely different experience.<br><br>So the experience of Prague also depends on the person, the place, the context and the situation. The fairest approach is to acknowledge the testimonies that exist without generalising to the whole city or its inhabitants.",
      "faq.q4": "Which bars to avoid, and where to go instead?", "faq.a4": "Around Old Town Square, many bars are very touristy: noisy, expensive and not always pleasant. For a beer in a more local setting, the beer gardens at Letná or Riegrovy sady are good choices. The Vinohrady and Žižkov neighbourhoods also offer quieter, more authentic places.",
      "faq.q5": "Which airport, and how do I reach the centre?", "faq.a5": "The airport is Václav Havel (code PRG). The simplest option is bus 119 to Nádraží Veleslavín, then the metro. Allow about 40 to 60 minutes to reach the centre. It is reliable and much cheaper than a taxi.",
      "faq.q6": "What budget should I plan for?", "faq.a6": "On average, €60 to €100 per day is enough for a comfortable stay. A local beer costs about €1.50 to €3, a meal €8 to €15, and most attractions between €10 and €20. You can of course spend less or more depending on your travel style.",
      "faq.q7": "How do the metro and public transport work?", "faq.a7": "The metro, tram and bus network is excellent and covers almost the whole city. A simple 30- or 90-minute ticket lets you combine all three — no need to buy a ticket per ride.<br><br>What struck me most: there are no turnstiles. You walk in freely, and yet nobody seems to cheat. Stations are often very deep, with endless escalators, and everything is clean and calm. Tap water is safe to drink, Wi-Fi is widely available; public toilets are often paid.",
      "faq.q8": "What is the best time to visit?", "faq.a8": "April–June and September–October are the most pleasant: mild weather, fewer crowds. Winter has the charm of the Christmas markets, but it is cold. July–August is high season: more people and higher prices.",
      "faq.q9": "Is a weekend enough for Prague?", "faq.a9": "Yes, to discover the heart of the city. In two days you can see the Old Town, the Astronomical Clock, Charles Bridge, Malá Strana, the Castle, the Jewish Quarter and even a detour through the metro. This journal is an example. A weekend is not enough, however, if you also want day trips (Kutná Hora, Český Krumlov, etc.).",
      "faq.q10": "Do I need to get up early for Charles Bridge?", "faq.a10": "Yes, if you want the bridge almost empty and soft light. At sunrise the atmosphere is very different from the daytime, when crowds are dense. The Castle at the end of the day, at sunset, also offers a memorable view over the city.",
      ...
      "about.mexico": "If you enjoyed Prague, keep travelling: discover my photo journal in Mexico — pyramids, colours and another way of feeling a city.",
    ...
    es: {
      ...
      "faq.q1": "¿Qué moneda usar?", "faq.a1": "En Praga se paga en coronas checas (CZK). Los euros rara vez se aceptan y, cuando se aceptan, el tipo de cambio suele ser malo. Una tarjeta Visa o Mastercard sin comisiones en el extranjero, más un poco de efectivo para los pequeños comercios, suele bastar.",
      "faq.q2": "¿Es segura Praga?", "faq.a2": "Sí, en general. Es una ciudad en la que se puede pasear con tranquilidad, también por la noche en el centro. Como en cualquier zona turística, hay que prestar atención a los carteristas y evitar los taxis no oficiales.",
      "faq.q3": "¿Hay racismo o xenofobia en Praga?", "faq.a3": "La respuesta es matizada. Praga es una ciudad turística y, en conjunto, los visitantes pueden alojarse con normalidad, sin problemas particulares ligados a su origen o al color de su piel.<br><br>Sin embargo, algunas personas pueden vivir experiencias distintas. Viajeros negros, árabes o asiáticos han reportado a veces miradas insistentes, cierta distancia en el trato, la sensación de ser más observados o, en algunos casos, dificultades para entrar en ciertos locales.<br><br>Estas situaciones no afectan a todos los viajeros y no permiten decir que Praga sea una ciudad racista o xenófoba. Forman parte, no obstante, de las experiencias que algunos visitantes pueden encontrar.<br><br>También es importante distinguir entre una experiencia personal y una realidad general. Una persona puede sentirse mal recibida en un lugar concreto mientras otra, en la misma ciudad, vive una experiencia totalmente distinta.<br><br>La experiencia de Praga depende también de la persona, del lugar, del contexto y de la situación. Lo más justo es reconocer los testimonios que existen sin generalizar a toda la ciudad o a sus habitantes.",
      "faq.q4": "¿Qué bares evitar y adónde ir mejor?", "faq.a4": "Alrededor de la Plaza de la Ciudad Vieja, muchos bares son muy turísticos: ruidosos, caros y no siempre agradables. Para una cerveza en un entorno más local, los jardines de cerveza de Letná o de Riegrovy sady son buenas opciones. Los barrios de Vinohrady y Žižkov ofrecen también lugares más tranquilos y auténticos.",
      "faq.q5": "¿Qué aeropuerto y cómo llegar al centro?", "faq.a5": "El aeropuerto se llama Václav Havel (código PRG). Lo más sencillo es tomar el autobús 119 hasta Nádraží Veleslavín y luego el metro. Cuenta con unos 40 a 60 minutos para llegar al centro. Es fiable y mucho más barato que un taxi.",
      "faq.q6": "¿Qué presupuesto prever?", "faq.a6": "De media, 60 a 100 € al día bastan para una estancia cómoda. Una cerveza local cuesta unos 1,50 a 3 €, una comida 8 a 15 €, y la mayoría de las atracciones entre 10 y 20 €. Se puede gastar menos o más según el estilo de viaje.",
      "faq.q7": "¿Cómo funcionan el metro y el transporte?", "faq.a7": "La red de metro, tranvía y autobús es excelente y cubre casi toda la ciudad. Un simple billete de 30 o 90 minutos permite combinar los tres, sin comprar un billete por trayecto.<br><br>Lo que más me marcó: la ausencia de torniquetes. Se entra libremente y, sin embargo, nadie parece hacer trampa. Las estaciones son a menudo muy profundas, con escaleras mecánicas interminables, y todo es limpio y tranquilo. El agua del grifo es potable, el Wi-Fi está muy disponible; los baños públicos suelen ser de pago.",
      "faq.q8": "¿Cuál es la mejor época para visitar?", "faq.a8": "Abril–junio y septiembre–octubre son las más agradables: clima suave, menos gente. El invierno tiene el encanto de los mercados navideños, pero hace frío. Julio–agosto es temporada alta: más gente y precios más altos.",
      "faq.q9": "¿Basta un fin de semana para Praga?", "faq.a9": "Sí, para descubrir el corazón de la ciudad. En dos días se puede ver la Ciudad Vieja, el reloj astronómico, el Puente de Carlos, Malá Strana, el Castillo, el barrio judío e incluso un desvío por el metro. Este diario es un ejemplo. En cambio, un fin de semana no basta si también se quieren excursiones (Kutná Hora, Český Krumlov, etc.).",
      "faq.q10": "¿Hay que madrugar para el Puente de Carlos?", "faq.a10": "Sí, si se quiere el puente casi vacío y una luz suave. Al amanecer el ambiente es muy distinto del del día, cuando la multitud es densa. El Castillo al final del día, al atardecer, ofrece también una vista memorable sobre la ciudad.",
      ...
      "about.mexico": "Si Praga te gustó, sigue el viaje: descubre mi diario fotográfico en México — pirámides, colores y otra forma de sentir una ciudad.",
